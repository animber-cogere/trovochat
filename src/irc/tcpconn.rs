...
// irc://irc.chat.trovo.tv:6697 (TLS)
// irc://irc.chat.trovo.tv:6667
// TODO connect_timeout
impl TcpConn {
    /// Connects to the non-TLS Trovo irc endpoint and registering with  [UserConfig](UserConfig)
    ///
    ...
    pub fn connect(config: &UserConfig) -> Result<Client<TcpStream, TcpStream>, Error> {
        const ADDRESS: &str = "irc.chat.trovo.tv:6667";
        ...
        client
            .write_line("CAP REQ :trovo.tv/membership")
            .and_then(|_| client.write_line("CAP REQ :trovo.tv/commands"))
            .and_then(|_| client.write_line("CAP REQ :trovo.tv/tags"))
