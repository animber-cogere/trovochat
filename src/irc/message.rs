...
impl<'a> IrcMessage<'a> {
    ...
    /// A Trovo Ready event -- `376`.
    ///
    /// This is sent by Trovo with your user information.
    ...
    /// An event from Trovo which you must reply to -- `PING`.
    ///
    /// If you do not reply to this within a reasonable time, Trovo will
    /// disconnect you.
    pub const PING: &'static str = "PING";
    /// A response from Trovo when you manually ping the server -- `PONG`.
    ...
    /// Trovo requests that you disconnect and reconnect -- `RECONNECT`.
