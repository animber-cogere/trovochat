...
/// Color represents a Trovo color
///
/// Trovo has named colors, and those with `Turbo` enabled accounts can set custom colors
///
/// A table of colors:
///
...
impl Default for Color {
    /// Defaults to having a kind of `TrovoColor::Turbo` and an RGB of `#FFFFFF`
    fn default() -> Self {
        Self {
...
impl FromStr for Color {
    type Err = ColorError;
    /// Tries to parse the trovo color name
    fn from_str(input: &str) -> Result<Self, Self::Err> {
        use TrovoColor::*;
...
mod tests {
    ...
    fn parse_color() {
        ...
        assert_eq!(color.kind, TrovoColor::Blue);
