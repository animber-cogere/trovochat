//! IRC message parsing.
//!
//! Trovo's chat is based on IRC, but not strictly conformant to the RFC-1459 and RFC-2812 specs.
//!
//! This provides a _Trovo-flavored_ IRC parser and types.
//!
//! # Parsing
//! You can use this crate to parse Trovo (IRC) messages from a `&str`.
//!
