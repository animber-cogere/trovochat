...
/// These tags apply to both the NOTICE (Trovo Commands) and NOTICE (Trovo Chat Rooms) commands.
#[non_exhaustive]
...
pub enum MessageId<'t> {
    ...
    AlreadySubsOn,
    /// You cannot ban admin <user>. Please email support@trovo.tv if an admin
    /// is being abusive.
    BadBanAdmin,
    ...
    BadBanBroadcaster,
    /// You cannot ban global moderator <user>. Please email support@trovo.tv
    ...
    BadBanSelf,
    /// You cannot ban staff <user>. Please email support@trovo.tv if a staff
    ...
    BadSlowDuration,
    /// You cannot timeout admin <user>. Please email support@trovo.tv if an
    ...
    /// support@trovo.tv if a global moderator is being abusive.
    BadTimeoutGlobalMod,
    ...
    BadTimeoutSelf,
    /// You cannot timeout staff <user>. Please email support@trovo.tv if a
    ...
    /// Facebook Connect in your Trovo settings under the connections tab.
    MsgFacebook,
    ...
    /// subscription at https://www.trovo.tv/products/<broadcaster login
    ...
    /// email at https://www.trovo.tv/settings/profile.
    MsgVerifiedEmail,
    /// No help available.
    NoHelp,
...
/// Message sent by a user on a channel
#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
/// Happens when the Trovo connection has been succesfully established
#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Ready<'t> {
    /// The name Trovo will refer to you as
...
/// Announces Trovo-specific events to the channel (e.g., a user's subscription notification).
#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
