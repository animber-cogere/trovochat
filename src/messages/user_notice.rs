use crate::trovo::{parse_badges, parse_emotes, Badge, BadgeInfo, Color, Emotes};
...
mod tests {
    ...
    fn user_notice_serde() {
        let input = &[
            ":tmi.trovo.tv USERNOTICE #museun :This room is no longer in slow mode.\r\n",
            ":tmi.trovo.tv USERNOTICE #museun\r\n",
